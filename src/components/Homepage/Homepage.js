            ...
            <div>
                ...
                <div id="alignMass">
                    ...
                    <div className="productDescription">
                        <h2 className="about">ABOUT</h2><h2 className="addToCart" onClick={localStorage.setItem('Cart', JSON.stringify([{name:'Iridescent Nike Cap',quantity:1,price:'188.00'}]))}>ADD TO CART</h2><a href="/shipping-zone"><h2 className="checkout">CHECKOUT</h2></a>
